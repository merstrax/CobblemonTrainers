...
import com.poketon.cobblemontrainers.util.CommandExecutor;
import lombok.Getter;
import lombok.Setter;

import static com.poketon.cobblemontrainers.util.CommandExecutor.CONSOLE;
...
public class Config extends JsonFile {
    ...
    public BattleAI getCurrentAI() {
        return new StrongBattleAI(strongAILevel);
    }
